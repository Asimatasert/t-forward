...
func main() {
	...
	mux.HandleFunc("/settings", acts.handleSettings)
	mux.HandleFunc("/admin/unlock", acts.handleAdminUnlock)
	...
	// config writes are privileged (gated behind the admin PIN once set)
